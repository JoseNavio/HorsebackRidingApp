...
class ViewHolderBookings(itemView: View, private val adapterBookings: AdapterBookings) :
    ...
    fun render(booking: Booking) {
        ...
        //Edit booking
        bindingBooking.itemBookingButtonEdit.setOnClickListener {
            adapterBookings.editBooking(booking)
        }
